...
#ifndef CC_CORE_ORCHESTRATOR_CLIENT_ORCHESTRATOR_CLIENT_INTERFACE_H_
#define CC_CORE_ORCHESTRATOR_CLIENT_ORCHESTRATOR_CLIENT_INTERFACE_H_
...
class OrchestratorClientInterface {
 public:
  ...
  // asynchronously.
  virtual absl::Status GetCurrentShardingScheme(
...
#endif  // CC_CORE_ORCHESTRATOR_CLIENT_ORCHESTRATOR_CLIENT_INTERFACE_H_
