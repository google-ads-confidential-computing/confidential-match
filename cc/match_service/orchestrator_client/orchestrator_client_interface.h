...
#ifndef CC_MATCH_SERVICE_ORCHESTRATOR_CLIENT_ORCHESTRATOR_CLIENT_INTERFACE_H_
#define CC_MATCH_SERVICE_ORCHESTRATOR_CLIENT_ORCHESTRATOR_CLIENT_INTERFACE_H_
...
// Interface for client that communicates with the Orchestrator.
class OrchestratorClientInterface {
 public:
  ...
  // asynchronously.
  virtual void GetCurrentShardingScheme(
      AsyncContext<orchestrator::GetCurrentShardingSchemeRequest,
                   orchestrator::GetCurrentShardingSchemeResponse>&
          get_sharding_scheme_context) noexcept = 0;
};

}  // namespace google::confidential_match::match_service

#endif  // CC_MATCH_SERVICE_ORCHESTRATOR_CLIENT_ORCHESTRATOR_CLIENT_INTERFACE_H_
