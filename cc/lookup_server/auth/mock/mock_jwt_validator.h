...
#ifndef CC_LOOKUP_SERVER_AUTH_MOCK_MOCK_JWT_VALIDATOR_H_
...
class MockJwtValidator : public JwtValidatorInterface {
 public:
...
#endif  // CC_LOOKUP_SERVER_AUTH_MOCK_MOCK_JWT_VALIDATOR_H_
