...
#ifndef CC_LOOKUP_SERVER_SERVER_SRC_CLOUD_PLATFORM_DEPENDENCY_FACTORY_LOCAL_LOCAL_DEPENDENCY_FACTORY_H_  // NOLINT(whitespace/line_length)
#define CC_LOOKUP_SERVER_SERVER_SRC_CLOUD_PLATFORM_DEPENDENCY_FACTORY_LOCAL_LOCAL_DEPENDENCY_FACTORY_H_  // NOLINT(whitespace/line_length)
...
// Factory to provide dependencies when running locally.
class LocalDependencyFactory : public CloudPlatformDependencyFactoryInterface {
 public:
  ...
  ConstructAuthorizationProxyClient(
      ...
      uint64_t key_expiration_safety_period_seconds) noexcept override;
...
#endif  // CC_LOOKUP_SERVER_SERVER_SRC_CLOUD_PLATFORM_DEPENDENCY_FACTORY_LOCAL_LOCAL_DEPENDENCY_FACTORY_H_
