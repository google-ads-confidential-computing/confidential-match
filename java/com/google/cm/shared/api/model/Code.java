...
package com.google.cm.shared.api.model;

import java.util.Arrays;

/** A subset of HTTP status codes from the 2xx, 4xx, and 5xx response classes. */
public enum Code {
  /**
   * Not an error, returned on success
   *
   * <p>HTTP Status Code: 200 OK
   */
  OK(200),
   ...
   *
   * <p>HTTP Status Code: 202 Accepted
   */
  ACCEPTED(202),
   ...
   *
   * <p>HTTP Status Code: 499 Client Closed Request
   */
  CANCELLED(499),
   ...
   * error.
   *
   * <p>HTTP Status Code: 500 Internal Server Error
   */
  UNKNOWN(500),
   ...
   *
   * <p>HTTP Status Code: 400 Bad Request
   */
   ...
   * deadline to expire.
   *
   * <p>HTTP Status Code: 504 Gateway Timeout
   */
   ...
   *
   * <p>HTTP Status Code: 404 Not Found
   */
  NOT_FOUND(404),
   ...
   *
   * <p>HTTP Status Code: 409 Conflict ALREADY_EXISTS(6, 409),
   */
  ALREADY_EXISTS(409),
   ...
   *
   * <p>HTTP Status Code: 401 Unauthorized
   */
  UNAUTHENTICATED(401),
   ...
   * is out of space.
   *
   * <p>HTTP Status Code: 429 Too Many Requests
   */
   ...
   * `UNAVAILABLE`.
   *
   * <p>HTTP Status Code: 409 Conflict
   */
  ABORTED(409),
   ...
   *
   * <p>HTTP Status Code: 501 Not Implemented
   */
  UNIMPLEMENTED(501),
   ...
   * `UNAVAILABLE`.
   *
   * <p>HTTP Status Code: 503 Service Unavailable
   */
  UNAVAILABLE(503),
  ...
  /**
   * Returns the enum value representing the given code, or {@link Code#UNKNOWN} if it is not found.
   */
  public static Code fromHttpStatusCode(int httpStatusCode) {
    return Arrays.stream(Code.values())
        .filter(status -> status.getHttpStatusCode() == httpStatusCode)
        .findFirst()
        .orElse(Code.UNKNOWN);
  }

  /** Returns true if the status code represents a successful request. */
  public static boolean isSuccessStatusCode(int httpStatusCode) {
    return httpStatusCode >= 200 && httpStatusCode <= 299;
  }

  /** Returns true if the status code represents a successful request. */
  public static boolean isSuccessStatusCode(Code code) {
    int httpStatusCode = code.getHttpStatusCode();
    return httpStatusCode >= 200 && httpStatusCode <= 299;
  }

  /** Returns the numeric code represented by the enum value. */
