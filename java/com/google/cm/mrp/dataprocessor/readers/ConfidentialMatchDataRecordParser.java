...
/** Interface for parsing {@link ConfidentialMatchDataRecord} into a list of {@link DataRecord}. */
public interface ConfidentialMatchDataRecordParser {

  /**
   * Parse ConfidentialMatchDataRecord and convert to list of internal DataRecord to be used in the
   * serialized proto reader.
   */
  List<DataRecord> parse(ConfidentialMatchDataRecord cfmDataRecord);
}
