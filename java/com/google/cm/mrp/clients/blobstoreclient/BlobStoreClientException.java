...
/** Exception to contain BlobStoreClient errors */
public class BlobStoreClientException extends Exception {
  private final JobResultCode errorCode;

  public BlobStoreClientException(String message, JobResultCode errorCode) {
    super(message);
    this.errorCode = errorCode;
  }

  public BlobStoreClientException(String message, Throwable cause, JobResultCode errorCode) {
    super(message, cause);
    this.errorCode = errorCode;
  }
