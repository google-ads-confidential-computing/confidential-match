...
/** Enumerates the modules used for instantiating a metric client. */
public enum MetricClientSelector {
  LOCAL(new LocalMetricModule()),
  GCP(new GcpMetricModule());

  private final Module metricClientModule;

  MetricClientSelector(Module module) {
    this.metricClientModule = module;
  }

  public Module getMetricClientModule() {
    return metricClientModule;
  }
}
